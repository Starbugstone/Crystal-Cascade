...
describe('Three levels and a growing frontier', () => {
  ...
  it('caps every building at level three and preserves existing benefits during improvements', () => {
    for (const building of BUILDINGS) {
      ...
      const town = village(Object.fromEntries(BUILDINGS.map((b) => [b.id, 3])));
...
describe('Modest saloon income without a collection chore', () => {
  ...
  it('settles the old rate before a hammer finishes an upgrade and reloads without paying twice', () => {
